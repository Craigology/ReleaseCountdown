...
namespace SaturnReleaseCountdown
{
    ...
    public class StarField
    {
        ...
        private static Brush[] _starColors = new Brush[] { _starColor1, _starColor2, _starColor3, _starColor4, _starColor5 };
        ...
        private void CreateStars()
        {
            ...
            for (int h = 0; h < PLANE_COUNT; h++)
            {
                ...
                for (int starCounter = 0; starCounter < starCountInPlane; starCounter++)
                {
                    ...
                    star.PrecomputedSpeed = 1 / ((star.Z + 0.5) * 10000); // artificial speed, looks nicer than the more reallistic one
